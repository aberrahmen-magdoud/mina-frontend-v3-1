...
// 4.6 Brief scroll state (for gradients)
...
const showPills = briefLength >= 3; // pills after 3 characters
const showStylesStep = briefLength >= 20; // styles after 20 characters
...
/* ===========================================================
6. Effects – bootstrap + persist + scroll
=========================================================== */
...
return (
  <div
    ...
    onDrop={handleDrop}
  >
    {/* Centered column with Input 1 + Input 2 */}
    <div className="studio-left-main">
      {/* =========================
          Input 1: pills + textarea
         ========================= */}
      <div className="studio-input1">
        {/* Pills sit above the textarea, absolutely positioned,
            so they never push the text area down. */}
        <div
          className={classNames(
            "studio-row",
            "studio-row--pills",
            showPills && "studio-row--pills-visible"
          )}
        >
          {/* Product pill (first) */}
          <button
